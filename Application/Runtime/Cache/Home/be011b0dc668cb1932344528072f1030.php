...
<header>
	...
	<div class="wrap-header zerogrid">
		<div class="row">
			<div class="col-1-3">
				<div id="logo"><a href="#"><h2>JASON BLOG</h2></a></div>
			</div>
			<div class="col-2-3">
				<nav>
					...
					<ul class="menu">
						...
						<li><a href="<?php echo U('About/index')?>">About</a></li>
...
<script type="text/javascript" src="Public/home/js/navigation.js"></script>
</body></html>